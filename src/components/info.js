              ...
              <div className="infoHowBox">
                <h3 className="questionHow">How does Bestow work?</h3>
                  ...
                  <img src="./addBtn.png" alt="add button" className="infoIcon" /> on the bottom right corner. Enter the information about
                   the item. <img src="./who.png" alt="who icon" className="infoIcon" /> is where you enter the name of the person that you
                   either borrowed from or bestowed to, <img src="./what.png" alt="what icon" className="infoIcon" /> is where you enter
                   what the item is, and <img src="./when.png" alt="when icon" className="infoIcon" /> is where you enter the date it was
                   ...
                   . <img src="./who.png" alt="who icon" className="infoIcon" /> will sort by the person's name
                   , <img src="./what.png" alt="what icon" className="infoIcon" /> will sort by the name of the item,
                   and <img src="./when.png" alt="when icon" className="infoIcon" /> will sort by the date. If you click the item in the list
